...
- Send only to official submission emails or application forms.
- Do not attach large video files; use links unless the agency asks otherwise.
- Personalize the first line for each agency.
- Track every submission in `casting_leads.csv`.
- Avoid anyone asking for registration fees, nude photos, urgent payment, or non-official email domains.
